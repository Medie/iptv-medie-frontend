...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-50 px-6 text-center text-slate-900 dark:bg-dark dark:text-slate-100">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Link
          href="/dashboard"
          className="rounded-md border border-slate-300 px-6 py-3 font-semibold text-slate-900 transition hover:border-primary hover:text-primary dark:border-slate-600 dark:text-slate-100"
        >
          View Dashboard
        </Link>
      </div>
